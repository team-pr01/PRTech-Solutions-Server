...
app.use(cors({ origin: ['http://localhost:5173', 'https://prtech-solutions-admin.vercel.app', 'https://prtech-solutions-helpdesk.vercel.app', 'https://helpdesk.prtech-solutions.com', 'https://admin.prtech-solutions.com'], credentials: true }));
