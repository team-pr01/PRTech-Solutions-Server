...
router.post("/raise", (0, auth_1.default)(auth_constants_1.UserRole.admin, auth_constants_1.UserRole.staff, auth_constants_1.UserRole.user), multer_config_1.multerUpload.array("files", 4), issue_controller_1.IssueController.raiseIssue);
// Get all issues
...
router.get("/my-issues", (0, auth_1.default)(auth_constants_1.UserRole.admin, auth_constants_1.UserRole.staff, auth_constants_1.UserRole.user), issue_controller_1.IssueController.getMyRaisedIssues);
// Get single issue
router.get("/:issueId", (0, auth_1.default)(auth_constants_1.UserRole.admin, auth_constants_1.UserRole.staff, auth_constants_1.UserRole.user), issue_controller_1.IssueController.getSingleIssue);
// Update issue status
